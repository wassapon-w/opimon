...
class MyTopo( Topo ):
    def __init__( self ):
        ...
        self.addLink(Host5, Switch12)
        self.addLink(Host6, Switch13)
        self.addLink(Host7, Switch13)
        self.addLink(Host8, Switch14)
        self.addLink(Host9, Switch15)
        self.addLink(Host10, Switch15) 
