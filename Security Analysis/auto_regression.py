...
# runtime_log = '/work/wassapon-w/network_output/runtime/runtime_day2_normal_autoreg_'+str(t)+'.csv'
runtime_log = '/work/wassapon-w/network_ddos_output/runtime/runtime_day2_ddos_autoreg_'+str(t)+'.csv'
...
for e in range(1, 21):
    for tau in range(1, 11):
        ...
        # output.to_csv('/work/wassapon-w/network_output/day2/ts_output_day2_autoreg_'+target_list[t]+"_E"+str(e)+"_tau"+str(tau)+"_tp"+str(tp)+'.csv', index=True, header=True)
        output.to_csv('/work/wassapon-w/network_ddos_output/day2/ts_ddos_output_day2_autoreg_'+target_list[t]+"_E"+str(e)+"_tau"+str(tau)+"_tp"+str(tp)+'.csv', index=True, header=True)
