...
# runtime_log = '/work/wassapon-w/network_output/kedm/runtime_day1_normal_kedm_'+str(t)+'.csv'
runtime_log = '/work/wassapon-w/network_ddos_output/runtime/runtime_day1_ddos_kedm_'+str(t)+'.csv'
...
for e in range(1, 21):
    for tau in range(1, 11):
        for tp in range(1, 6):
            ...
            time_series = pd.read_csv('/work/wassapon-w/darpa_ts/ts_output_day2_norm.csv', header=0, index_col=0)
            time_series_ddos = pd.read_csv('/work/wassapon-w/darpa_ts/ts_ddos_output_day2_norm.csv', header=0, index_col=0)
            ...
            output.to_csv("/work/wassapon-w/network_output/kedm/ts_output_day2_kedm_"+target_list[t]+"_E"+str(e)+"_tau"+str(tau)+"_tp"+str(tp)+".csv", index=True, header=True)
            # output.to_csv("/work/wassapon-w/network_ddos_output/kedm/ts_ddos_output_day2_kedm_"+target_list[t]+"_E"+str(e)+"_tau"+str(tau)+"_tp"+str(tp)+".csv", index=True, header=True)
